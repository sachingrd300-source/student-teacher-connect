            ...
            <div className="space-y-4">
              ...
              <ul className="grid gap-4">
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-success mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold">Find the Best Local Tutors</h3>
                    <p className="text-sm text-muted-foreground">Search for the best teachers in your area for all subjects and classes. Find options for both coaching centers and private home tuition, and enroll instantly.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-success mt-1 flex-shrink-0" />
