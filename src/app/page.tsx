        ...
        <section className="relative h-[60vh] md:h-[80vh] flex items-center justify-center text-center text-white">
            ...
            <div className="relative z-10 p-4 animate-fade-in-down max-w-4xl">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button asChild size="lg" variant="secondary" className="font-semibold shadow-md hover:shadow-lg transition-shadow">
            ...
            <div className="container px-4 md:px-6 space-y-16">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-4">
                        <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm font-semibold">Expert Teachers</div>
                    ...
                    <div>
                        <Image src={expertTeachers.src} alt={expertTeachers.alt} width={expertTeachers.width} height={expertTeachers.height} className="rounded-xl shadow-2xl" data-ai-hint={expertTeachers.hint} />
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="order-last md:order-first">
                         <Image src={interactiveBatches.src} alt={interactiveBatches.alt} width={interactiveBatches.width} height={interactiveBatches.height} className="rounded-xl shadow-2xl" data-ai-hint={interactiveBatches.hint} />
                    </div>
                     <div className="space-y-4 md:text-right md:items-end flex flex-col">
                        <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm font-semibold">Interactive Batches</div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-4">
                        <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm font-semibold">Seamless Organization</div>
                    ...
                    <div>
                        <Image src={organizedMaterials.src} alt={organizedMaterials.alt} width={organizedMaterials.width} height={organizedMaterials.height} className="rounded-xl shadow-2xl" data-ai-hint={organizedMaterials.hint} />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-background">
             <div className="container px-4 md:px-6 flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div className="w-full max-w-lg mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                    <Link href="/signup" className="group flex flex-col items-center justify-center p-8 rounded-lg border bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <Link href="/signup/teacher" className="group flex flex-col items-center justify-center p-8 rounded-lg border bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
