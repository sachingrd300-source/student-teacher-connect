    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-muted/40 py-12">
      <div className="w-full max-w-sm p-4 sm:p-0">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold font-serif text-foreground mt-2">Student Registration</h1>
            <p className="text-muted-foreground">Create your student account.</p>
          </div>
          <Card>
            <CardHeader>
                <CardTitle className="text-xl font-serif">Sign up as a Student</CardTitle>
                <CardDescription>
                    Not a student?{' '}
