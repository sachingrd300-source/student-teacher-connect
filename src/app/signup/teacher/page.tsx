    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-muted/40 py-12">
      <div className="w-full max-w-sm p-4 sm:p-0">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold font-serif text-foreground mt-2">Teacher Registration</h1>
            <p className="text-muted-foreground">Create your teacher account.</p>
          </div>
          <Card>
            <CardHeader>
                <CardTitle className="text-xl font-serif">Sign up as a Teacher</CardTitle>
                <CardDescription>
                    Not a teacher?{' '}
            ...
            <CardContent>
              ...
              <form onSubmit={handleSignUp} className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input id="full-name" placeholder="Jane Smith" required value={name} onChange={(e) => setName(e.target.value)} />
                </div>
                <div className="grid gap-2">
