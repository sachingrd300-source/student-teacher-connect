    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-muted/40 py-12">
      <div className="w-full max-w-sm p-4 sm:p-0">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold font-serif text-foreground mt-2">Teacher Account</h1>
            <p className="text-muted-foreground">Create your teacher account to get started.</p>
          </div>
          <Card>
            <CardHeader>
                <CardTitle className="text-xl font-serif">Teacher Sign Up</CardTitle>
            </CardHeader>
            <CardContent>
              {error && (
