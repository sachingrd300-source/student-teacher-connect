...
import { collection, query, where, orderBy, doc, addDoc, deleteDoc, writeBatch, updateDoc } from 'firebase/firestore';
...
import { Loader2, School, Users, FileText, ShoppingBag, Home, Briefcase, Eye, ArrowLeft, Upload, Trash, Check, X, PackageOpen, DollarSign } from 'lucide-react';
                             ...
                             <Tabs defaultValue="users" className="w-full">
                                <TabsList className="grid w-full grid-cols-2 md:grid-cols-5">
                                    <TabsTrigger value="users">
                                        <Users className="mr-2 h-4 w-4" /> Users ({allUsers.length})
                                    </TabsTrigger>
                                    <TabsTrigger value="materials">
                                        <FileText className="mr-2 h-4 w-4" /> Materials ({materials?.length || 0})
                                    </TabsTrigger>
                                    <TabsTrigger value="shop">
                                        <ShoppingBag className="mr-2 h-4 w-4" /> Shop ({shopItems?.length || 0})
                                    </TabsTrigger>
                                    <TabsTrigger value="bookings">
                                        <Home className="mr-2 h-4 w-4" /> Bookings ({homeBookings?.length || 0})
                                    </TabsTrigger>
                                    <TabsTrigger value="applications">
                                        <Briefcase className="mr-2 h-4 w-4" /> Applications ({homeTutorApplications?.length || 0})
                                    </TabsTrigger>
                                </TabsList>
                                ...
                                <TabsContent value="materials" className="mt-6 space-y-6">
                                    <div className="grid gap-6 p-6 border rounded-lg bg-background">
                                    ...
                                    <h3 className="text-lg font-semibold">Uploaded Free Materials</h3>
                                ...
                                <TabsContent value="shop" className="mt-6 space-y-6">
                                    ...
                                    <h3 className="text-lg font-semibold">Existing Shop Items</h3>
                                    <div>
