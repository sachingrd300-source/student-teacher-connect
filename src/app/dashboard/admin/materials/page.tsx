...
import { collection, doc, query, orderBy, addDoc, deleteDoc } from 'firebase/firestore';
...
import { Loader2, Upload, FileText, Trash, ArrowLeft, School } from 'lucide-react';
    ...
    if (isLoading || !userProfile) {
        return (
            <div className="flex h-screen flex-col items-center justify-center bg-background gap-4">
                ...
                <p className="text-muted-foreground">Loading Material Management...</p>
            </div>
        );
    }
