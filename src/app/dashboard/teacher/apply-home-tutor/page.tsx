...
export default function ApplyHomeTutorPage() {
    ...
    const renderStatusCard = () => {
            ...
            return (
                <Card className="rounded-2xl shadow-lg">
                    <CardHeader>
                        ...
                        <CardDescription>Join our exclusive program to get connected with students seeking personalized home tuition. Submit your application for review by our admin team.</CardDescription>
                    </CardHeader>
                    <CardContent>
        ...
        switch (existingApplication.status) {
            case 'approved':
                ...
                statusDescription = "Congratulations! You are now listed as a verified home tutor.";
                break;
            case 'rejected':
