  ...
  return (
    <div className="space-y-6">
      ...
      {!isConnected ? (
        <Card>
            <CardHeader>
                <CardTitle>Connect with Your Teacher</CardTitle>
                <CardDescription>Enter your teacher's code to unlock your full dashboard, including personalized schedules, practice papers, and performance tracking.</CardDescription>
            </CardHeader>
            <CardContent>
